...
export default function TemplateName({initialValue = 0}: Props) {
  ...
  return (
    <div className="border-slate-300 w-60 border p-6 text-center">
      ...
      <button
        className="bg-teal-600 mb-6 rounded-lg px-6 py-3 text-base text-white drop-shadow-md active:relative active:left-0.5 active:top-0.5 active:drop-shadow-none"
        type="button"
